...
// the web app's libsodium-wrappers-sumo. The encrypt/seal side is random and not
// ported; the parity vectors (shared/parity-json/e2ee.json) freeze the reverse
// direction, and this must reproduce them byte-for-byte.
//
// Pass an initialized Sodium (see e2ee_interop_test.dart for loading libsodium in
// a plain `dart test`; in the app it comes from sodium_libs).

// url-safe base64, NO padding (matches base64_variants.URLSAFE_NO_PADDING).
