...
const stack: { group: string; items: StackItem[] }[] = [
  {
    ...
    items: [
      ...
      { name: 'libsodium.js', icon: 'pi pi-lock', desc: 'The sodium crypto library compiled to WebAssembly and pure JavaScript', url: 'https://github.com/jedisct1/libsodium.js', license: 'ISC', licenseUrl: 'https://github.com/jedisct1/libsodium.js/blob/master/LICENSE' },
