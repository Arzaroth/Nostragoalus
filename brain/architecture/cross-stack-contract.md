...
- [apps/web-nuxt/server/utils/openapi/contract.ts](../../apps/web-nuxt/server/utils/openapi/contract.ts) -
...
- [validated-handler.ts](../../apps/web-nuxt/server/utils/validated-handler.ts) - the mutation
...
- [read-handler.ts](../../apps/web-nuxt/server/utils/read-handler.ts) - `defineReadHandler`,
...
returns; the emitter
([apps/web-nuxt/tests/contract/openapi.test.ts](../../apps/web-nuxt/tests/contract/openapi.test.ts)) stubs
the h3/Nitro globals, imports every `apps/web-nuxt/server/api` route, reads that `__contract`,
...
schema (see [validated-handler.ts](../../apps/web-nuxt/server/utils/validated-handler.ts)
