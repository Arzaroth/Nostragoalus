...
Not to be confused with [`server/utils/stats/alltime-h2h.ts`](../../server/utils/stats/alltime-h2h.ts),
...
- [`server/utils/analytics/h2h.ts`](../../server/utils/analytics/h2h.ts) -
  ...
  derivation reuses `outcomeOf` from [`scoring/tiers.ts`](../../server/utils/scoring/tiers.ts).
- **Privacy**: `getHeadToHead` enforces `canViewProfile`
  ([`leagues/service.ts`](../../server/utils/leagues/service.ts)) for **both**
...
- Route [`server/api/head-to-head.get.ts`](../../server/api/head-to-head.get.ts) -
...
- DTO in [`#shared/types/h2h`](../../shared/types/h2h.ts).
- Client: [`app/composables/useHeadToHead.ts`](../../app/composables/useHeadToHead.ts)
  (vue-query, key `['head-to-head', slug, a, b]`, disabled until both ids differ)
  -> [`app/pages/[competition]/compare.vue`](../../app/pages/%5Bcompetition%5D/compare.vue)
  (reads `?a=&b=`, empty/error states) -> presentational
  [`app/components/H2HReport.vue`](../../app/components/H2HReport.vue). The lead
  chart uses the shared [`app/utils/sparkline.ts`](../../app/utils/sparkline.ts)
  geometry helpers.
- Entry: a "Compare" button on a player's profile
  ([`users/[id].vue`](../../app/pages/%5Bcompetition%5D/users/%5Bid%5D.vue)),
...
- [`server/utils/analytics/h2h.ts`](../../server/utils/analytics/h2h.ts)
- [`server/api/head-to-head.get.ts`](../../server/api/head-to-head.get.ts)
- [`shared/types/h2h.ts`](../../shared/types/h2h.ts)
- [`app/composables/useHeadToHead.ts`](../../app/composables/useHeadToHead.ts)
- [`app/pages/[competition]/compare.vue`](../../app/pages/%5Bcompetition%5D/compare.vue)
- [`app/components/H2HReport.vue`](../../app/components/H2HReport.vue)
- [`app/utils/sparkline.ts`](../../app/utils/sparkline.ts)
